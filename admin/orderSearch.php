...
$sql = "select * from orders where OrderId like '%$ordersearch%'";
...
<form class="navbar-form navbar-right" method="post" action="orderSearch.php">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="ordersearch"
               placeholder="<?php echo ($ordersearch == '') ? '' : $ordersearch; ?>"/>
    </div>
...
<table class="table table-bordered table-hover">
    ...
    if (!empty($data)) {
        ...
        echo "<tr><td colspan='13'><h3>没有查询到相关订单信息！</h3></td></tr>";
    ?>
    </tbody>
</table>
</div>
