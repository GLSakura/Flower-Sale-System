...
switch ($order) {
    case '':
    case 'default':
        $sql = "select * from goods where SoldNumber>100";
        break;
    case 'timefromnew':
        $sql = "select * from goods where SoldNumber>100 order by UpdateTime desc";
        break;
    case 'timefromold':
        $sql = "select * from goods where SoldNumber>100 order by UpdateTime";
        break;
    case 'pricefromhigh':
        $sql = "select * from goods where SoldNumber>100 order by GoodPrice1 desc";
        break;
    case 'pricefromlow':
        $sql = "select * from goods where SoldNumber>100 order by GoodPrice1";
        break;
    case 'soldfromhigh':
        $sql = "select * from goods where SoldNumber>100 order by SoldNumber desc";
        break;
    case 'soldfromlow':
        $sql = "select * from goods where SoldNumber>100 order by SoldNumber";
        break;
}
